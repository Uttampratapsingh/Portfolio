...
const SelfProjects = () => {
    const Project=[
    {
      id: 1,
      title: "Music Library",
      description: "A music library app using the iTunes API to browse and preview 30-second song clips with real-time search, genre filters, playlist support, and fully responsive modern design.",
      skills: ["ReactJs", "Tailwind", "Javascript", "APIs"],
      githubLink: "https://github.com/Uttampratapsingh/Music-Library",
      liveDemoLink: "https://music-library-gamma.vercel.app"
    },
    {
      id: 2,
      title: "Fetch Train",
      description: "A train information app powered by live API data. It includes station search, coach position tracking, station location mapping, and detailed train schedules for easy planning.",
      skills: ["ReactJs", "Tailwind", "Javascript", "APIs"],
      githubLink: "https://github.com/Uttampratapsingh/Fetch-Train",
      liveDemoLink: "https://fetch-train.vercel.app"
    },
    {
      id: 3,
      title: "ChatBot",
      description: "An AI chatbot with real-time interaction like ChatGPT, featuring user login/signup, dark-light mode toggle, typing animation, message history, and a smooth, responsive chat interface.",
      skills: ["ReactJs", "Tailwind", "Javascript", "APIs"],
      githubLink: "https://github.com/Uttampratapsingh/ChatBot",
      liveDemoLink: "https://chat-bot-six-sand.vercel.app"
    },
    {
      id: 4,
      title: "Find TalentAi",
      description: "A smart job posting interface where you enter a job title, and AI auto-fills the form by generating the job description, key responsibilities, required skills, and qualifications.",
      skills: ["ReactJs", "Tailwind", "Javascript", "APIs"],
      githubLink: "https://github.com/Uttampratapsingh/FindTalentAI",
            ...
            {/* Header Section */}
             <div className="text-center mb-16 relative">
                ...
                <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                    A curated collection of personal projects showcasing innovation, technical expertise, and creative problem-solving
                </p>
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                {Project.map((project,index)=>(
                    ...
                    >
                        ...
                        <div className={`absolute top-6 right-6 w-12 h-12 bg-gradient-to-br ${accentColors[index]}/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow-lg group-hover:rotate-6 transition-transform duration-500`}>
                            <Code2 className={`w-6 h-6 ${index === 0 ? 'text-pink-600' : index === 1 ? 'text-blue-600' : index === 2 ? 'text-purple-600' : 'text-green-600'}`} />
                        </div>
                        ...
                        <div className={`absolute inset-0 bg-gradient-to-br ${bubbleThemes[index]} pointer-events-none`}></div>
                        <div className={`absolute -bottom-20 -right-20 w-40 h-40 bg-gradient-to-br ${accentColors[index]}/20 rounded-full group-hover:scale-110 transition-transform duration-700 pointer-events-none`}></div>
                    </div>
                ))}
             </div>
        </div>
